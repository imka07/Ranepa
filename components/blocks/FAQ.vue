    ...
    <script type="application/ld+json">
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Сколько стоит написать диплом?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Стоимость написания дипломной работы начинается от 15 000 рублей в зависимости от объема, сложности темы и сроков выполнения. Окончательная цена определяется после обсуждения всех требований к работе."
            }
          },
          {
            "@type": "Question",
            "name": "Какие сроки выполнения работ?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Сроки зависят от типа работы: реферат — от 3 дней, курсовая — от 7 дней, диплом — от 14 дней. Мы можем работать в срочном режиме при необходимости."
            }
          },
          {
            "@type": "Question",
            "name": "Гарантируете ли вы уникальность работы?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Да, все работы проходят проверку на уникальность через системы Антиплагиат. Мы гарантируем уникальность не менее 70-80% в зависимости от требований вашего учебного заведения. Предоставляем отчет о проверке."
            }
          },
          {
            "@type": "Question",
            "name": "Можно ли вносить правки в готовую работу?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Да, все правки и доработки вносятся бесплатно в течение 14 дней после сдачи работы. Мы работаем до полного удовлетворения ваших требований."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Оплата производится поэтапно: 50% предоплата при начале работы, оставшиеся 50% — после получения готовой работы. Принимаем оплату по карте, через СБП и электронные кошельки."
            }
          },
          {
            "@type": "Question",
            "name": "Работаете ли вы со студентами РАНХиГС?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Да, мы имеем большой опыт работы со студентами РАНХиГС. Знаем специфику требований и особенности оформления работ в этом университете."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Все данные клиентов защищены и не передаются третьим лицам. Мы подписываем соглашение о конфиденциальности и гарантируем полную анонимность."
            }
          },
          {
            "@type": "Question",
            "name": "Что будет, если работа не пройдет проверку?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Мы бесплатно доработаем работу до успешной сдачи. Если преподаватель указал на недочеты, мы их устраним. В случае несоответствия работы заявленным требованиям — вернем деньги."
            }
          }
        ]
      }
...
const faqItems = [
  ...
  {
    question: 'Работаете ли вы со студентами РАНХиГС?',
    answer: 'Да, мы имеем большой опыт работы со студентами РАНХиГС. Знаем специфику требований и особенности оформления работ в этом университете.'
  },
  {
