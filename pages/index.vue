<template>
  <div>
    ...
    <Hero
      eyebrow="Reshala"
      title="Помощь студентам: дипломы, курсовые, рефераты на заказ"
      :subtitles="[
...
// Schema.org разметка через useHead
useHead({
  script: [
    {
     ...
     innerHTML: JSON.stringify({
        ...
        '@type': 'LocalBusiness',
        name: 'Reshala',
        description: 'Профессиональная помощь студентам: написание дипломов, курсовых, рефератов',
        url: 'https://reshala.netlify.app',
        aggregateRating: {
