...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      title: 'Помощь студентам РАНХиГС | Дипломы, Курсовые, Рефераты',
      titleTemplate: '%s',
      meta: [
        { charset: 'utf-8' },
        ...
        { 
          name: 'keywords', 
          content: 'помощь студентам РАНХиГС, написать диплом, заказать курсовую, реферат на заказ, консультации по учебе, решение задач, презентации' 
        },
